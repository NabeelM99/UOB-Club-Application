    ...
    async initializePage(){
      ...
      if (userDoc.exists) {
        ...
        console.log('User document does not exist');
          ...
          const collectionName = 'graduates';
  ...
  if(this.clubName == this.pendValue){
    ...
    this.presentLoadingClub().then(() => {
      ...
      goToDetails(record: Record,i:number) {
        this.tab11=true;
        this.grad=true;
      this.router.navigate(['event-details'], { state: { grad:this.grad,record, bail: this.bails[i],leader:this.leader,tab1:this.tab1,tab11:this.tab11 } });
      }
      async openModal(){
