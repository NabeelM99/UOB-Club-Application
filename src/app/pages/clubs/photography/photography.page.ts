...
export class PhotographyPage implements OnInit {
  ...
  public bails = []as any;
  public page:string='photography';
  public ds={date:[]as any,time:[]as any};
  public imgs={urls:[]as any};
  public isadmin:boolean=false;
  public userId:any;
  public clubName:string='photography';
  ...
  if(this.clubName == this.pendValue){
    ...
    this.presentLoadingClub().then(() => {
      ...
      goToDetails(record: Record,i:number) {
        this.tab11=true;
        this.photo=true;
      this.router.navigate(['event-details'], { state: {photo:this.photo, record, bail: this.bails[i],leader:this.leader,tab1:this.tab1,tab11:this.tab11 } });
      }
      async openModal(){
