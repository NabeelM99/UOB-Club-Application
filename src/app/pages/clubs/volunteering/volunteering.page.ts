...
export class VolunteeringPage implements OnInit {
  public events : Record[] = [];
  public bails = []as any;
  public page:string='volunteering';
  public ds={date:[]as any,time:[]as any};
  public imgs={urls:[]as any};
  public isadmin:boolean=false;
  public userId:any;
  public clubName:string='volunteering';
    ...
    async initializePage(){
      ...
      if (userDoc.exists) {
        ...
        console.log('User document does not exist');
          ...
          const collectionName = 'volunteering';
  ...
  if(this.clubName == this.pendValue){
    ...
    this.presentLoadingClub().then(() => {
      ...
      goToDetails(record: Record,i:number) {
        this.tab11=true;
        this.volu=true;
      this.router.navigate(['event-details'], { state: {volu:this.volu, record, bail: this.bails[i],leader:this.leader,tab1:this.tab1,tab11:this.tab11 } });
      }
      async openModal(){
