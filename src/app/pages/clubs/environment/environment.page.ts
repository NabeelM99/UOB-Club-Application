...
import { DocumentReference, AngularFirestoreCollection } from '@angular/fire/compat/firestore';
...
export class EnvironmentPage implements OnInit {
  public events: Observable<Record[]> | any;
  public page:string='environment';
  public ds={date:[]as any,time:[]as any};
  public userId:any;
  public isadmin:boolean=false;
  public imgs={urls:[]as any};
  public bails = []as any;
  public clubName:string='environment';
    ...
    async initializePage(){
      ...
      if (userDoc.exists) {
        ...
        console.log('User document does not exist');
          ...
          const collectionName = 'environment';
  ...
  if(this.clubName == this.pendValue){
    ...
    this.presentLoadingClub().then(() => {
      ...
      goToDetails(record: Record,i:number) {
        this.tab11=true;
        this.envi=true;
      this.router.navigate(['event-details'], { state: {envi:this.envi, record, bail: this.bails[i],leader:this.leader,tab1:this.tab1,tab11:this.tab11 } });
      }
      async openModal(){
