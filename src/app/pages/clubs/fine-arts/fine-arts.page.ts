...
@Component({
  ...
  templateUrl: './fine-arts.page.html',
  styleUrls: ['./fine-arts.page.scss'],
})
export class FineArtsPage implements OnInit {
  public events : Record[] = [];
  public bails = []as any;
  public page:string='fine-arts';
  public ds={date:[]as any,time:[]as any};
  public imgs={urls:[]as any};
  public isadmin:boolean=false;
  public userId:any;
  public clubName:string='fine-arts';
    ...
    async initializePage(){
      ...
      if (userDoc.exists) {
        ...
        console.log('User document does not exist');
          ...
          const collectionName = 'fine-arts';
  ...
  if(this.clubName == this.pendValue){
    ...
    this.presentLoadingClub().then(() => {
      ...
      goToDetails(record: Record,i:number) {
        this.tab11=true;
        this.fine=true;
      this.router.navigate(['event-details'], { state: { fine:this.fine,record, bail: this.bails[i],leader:this.leader,tab1:this.tab1,tab11:this.tab11 } });
      }
      async openModal(){
