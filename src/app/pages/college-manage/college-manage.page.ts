...
@Component({
  ...
  templateUrl: './college-manage.page.html',
  styleUrls: ['./college-manage.page.scss'],
})
export class CollegeManagePage implements OnInit {
  va: any;
...
public formbuilder: FormBuilder,
  ...
  goBck(){
    this.router.navigate(['college-events'], {state:{edit:this.edit}});
  }
  async manageClub() {
    ...
    goToDetails(record: Record,i:number) {
      ...
      this.edit=true;
      this.manage=true;
      this.router.navigate(['event-details'], { state: {manage:this.manage,edit:this.edit,iamleader:this.iamleader,colleges:this.colleges, record, bail: this.bails[i],leader:this.leader,tab11:this.tab11 } });
    }
    async openModal(){
